                    ...
                    <div className={styles.deck}>
                        {
                            ...
                            <Card name={pokemon.name.english} image={'https://assets.pokemon.com/assets/cms2/img/pokedex/full/'+(pokemon.id).toString().padStart(3,'0')+'.png'} types={pokemon.type} key={i} number={(pokemon.id -1)}></Card>
                        )}
